...
def optimize_conv_model(memory, policy_net, target_net, optimizer):
    ...
    #when we pop out of the batch it comes out shape [1, 512, 84, 84] so need to reshape so its batches of 4 channels
    reshaped_state_batch = state_batch.view(128, 4, 84, 84)
